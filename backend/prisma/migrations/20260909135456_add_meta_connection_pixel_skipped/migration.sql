...
CREATE TABLE "new_MetaConnection" (
    ...
    "pageId" TEXT,
    "pixelId" TEXT,
    "pixelSkipped" BOOLEAN NOT NULL DEFAULT false,
...
INSERT INTO "new_MetaConnection" ("accessToken", "adAccountId", "businessId", "createdAt", "id", "metaUserId", "pageId", "pixelId", "tokenExpiresAt", "updatedAt") SELECT "accessToken", "adAccountId", "businessId", "createdAt", "id", "metaUserId", "pageId", "pixelId", "tokenExpiresAt", "updatedAt" FROM "MetaConnection";
